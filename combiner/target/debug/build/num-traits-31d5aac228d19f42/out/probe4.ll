...
define internal void @"_ZN51_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$GT$10add_assign17h1e77322e6f64bdfdE"(i32* align 4 dereferenceable(4) %self, i32 %other) unnamed_addr #0 {
start:
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17h4402be0bef586fb3E"(i32* align 4 dereferenceable(4) %self, i32* noalias readonly align 4 dereferenceable(4) %other) unnamed_addr #0 {
start:
  %_5 = load i32, i32* %other, align 4
; call <i32 as core::ops::arith::AddAssign>::add_assign
  call void @"_ZN51_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$GT$10add_assign17h1e77322e6f64bdfdE"(i32* align 4 dereferenceable(4) %self, i32 %_5)
  br label %bb1
...
define void @_ZN6probe45probe17ha666d4c5e77d332dE() unnamed_addr #1 {
start:
  %x = alloca i32, align 4
  store i32 1, i32* %x, align 4
  %_5 = load i32*, i32** bitcast (<{ i8*, [0 x i8] }>* @0 to i32**), align 8, !nonnull !2
; call <i32 as core::ops::arith::AddAssign<&i32>>::add_assign
  call void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17h4402be0bef586fb3E"(i32* align 4 dereferenceable(4) %x, i32* noalias readonly align 4 dereferenceable(4) %_5)
  br label %bb1
